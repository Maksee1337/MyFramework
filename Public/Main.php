...
{
    /**
     * Main constructor. Работает как основной поток нашей программы.
     * Ищет необходнывый метод, которы соответвует нашему пути, и выполняет его
     *
     * @author Maks Voytenko <m.voytenko1991@gmail.com>
     */
    ...
    /**
     * Функция получает путь из ссылки в браузере
     *
     * @author Maks Voytenko <m.voytenko1991@gmail.com>
     *
     * @return string
